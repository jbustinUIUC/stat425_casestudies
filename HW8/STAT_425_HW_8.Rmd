...
#fitting model
##I beleive this is breaking due to the way our levels for region are set up. I'll take another look later unless someone else wants to.
fit = lm(num_physicians ~ . , data=model_train[, c(select.var, "num_physicians")])
